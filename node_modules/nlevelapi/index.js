...
LevelDB = nfix.Class(Object, function(dbPath) {
...
LevelDB.fn.open = function() {
    return nfix.Promise((resolve, reject) => {
        if(!this.isOpened())
...
LevelDB.fn.iterate = function(options, f) {
    options = nfix.merge({}, LevelDB.defaultOptions, options, prefix(options.prefix));
    this.$db.createReadStream(options).on('data', (data) => f.call(this, data.key, data.value));
};
